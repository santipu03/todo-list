import { openModal, renderHomeTab,renderPriorityTab,closeModal,clearErrorMsg,clearForm,renderEditTaskModal,renderProjectTasks,renderProject,renderTask,removeTaskFromScreen,renderErrorMsg,removeProjectFromScreen, renderTodayTab,renderWeekTab } from './Render';
...
const setDefaultEventListeners = () => {
    ...
    document.querySelector('.aside-today').addEventListener('click',renderTodayTab);
